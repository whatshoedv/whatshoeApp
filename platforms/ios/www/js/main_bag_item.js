 ...
 */
localStorage.bagCost = 0; //각 항목별 비용 총 합계 로컬
...
$('#item_bag_item1').click(function () {
    ...
    if (document.getElementById('item_bag_input1').value == 'NULL') {
        ...
        document.getElementById('item_bag_subject').textContent = document.getElementById('item_bag_list1').value.toString();
    } else {
...
$('#item_bag_item2').click(function () {
    ...
    if (document.getElementById('item_bag_input2').value == 'NULL') {
        ...
        document.getElementById('item_bag_cost').textContent = localStorage.bagCost+"원";
        document.getElementById('item_bag_subject').textContent = document.getElementById('item_bag_list2').value.toString();
    } else {
        item_row.style.backgroundColor = "#ffffff";
...
$('#item_bag_item3').click(function () {
    ...
    if (document.getElementById('item_bag_input3').value == 'NULL') {
        ...
        document.getElementById('item_bag_cost').textContent = localStorage.bagCost+"원";
        document.getElementById('item_bag_subject').textContent = document.getElementById('item_bag_list3').value.toString();
    } else {
        item_row.style.backgroundColor = "#ffffff";
...
$('#item_bag_item4').click(function () {
    ...
    if (document.getElementById('item_bag_input4').value == 'NULL') {
        ...
        document.getElementById('item_bag_cost').textContent = localStorage.bagCost+"원";
        document.getElementById('item_bag_subject').textContent = document.getElementById('item_bag_list4').value.toString();
    } else {
        item_row.style.backgroundColor = "#ffffff";
...
$('#item_bag_item5').click(function () {
    ...
    if (document.getElementById('item_bag_input5').value == 'NULL') {
        ...
        document.getElementById('item_bag_cost').textContent = localStorage.bagCost+"원";
        document.getElementById('item_bag_subject').textContent = document.getElementById('item_bag_list5').value.toString();
    } else {
        item_row.style.backgroundColor = "#ffffff";
...
$('#item_bag_item6').click(function () {
    ...
    if (document.getElementById('item_bag_input6').value == 'NULL') {
        ...
        document.getElementById('item_bag_cost').textContent = localStorage.bagCost+"원";
        document.getElementById('item_bag_subject').textContent = document.getElementById('item_bag_list6').value.toString();
    } else {
        item_row.style.backgroundColor = "#ffffff";
...
$('#item_bag_item7').click(function () {
    ...
    if (document.getElementById('item_bag_input7').value == 'NULL') {
        ...
        document.getElementById('item_bag_cost').textContent = localStorage.bagCost+"원";
        document.getElementById('item_bag_subject').textContent = document.getElementById('item_bag_list7').value.toString();
    } else {
        item_row.style.backgroundColor = "#ffffff";
...
$('#item_bag_item8').click(function () {
    ...
    if (document.getElementById('item_bag_input8').value == 'NULL') {
        ...
        document.getElementById('item_bag_cost').textContent = localStorage.bagCost+"원";
        document.getElementById('item_bag_subject').textContent = document.getElementById('item_bag_list8').value.toString();
    } else {
        item_row.style.backgroundColor = "#ffffff";
...
$('#item_bag_item9').click(function () {
    ...
    if (document.getElementById('item_bag_input9').value == 'NULL') {
        ...
        document.getElementById('item_bag_cost').textContent = localStorage.bagCost+"원";
        document.getElementById('item_bag_subject').textContent = document.getElementById('item_bag_list9').value.toString();
    } else {
        item_row.style.backgroundColor = "#ffffff";
...
$('#item_bag_item10').click(function () {
    ...
    if (document.getElementById('item_bag_input10').value == 'NULL') {
        ...
        document.getElementById('item_bag_cost').textContent = localStorage.bagCost+"원";
        document.getElementById('item_bag_subject').textContent = document.getElementById('item_bag_list10').value.toString();
    } else {
        item_row.style.backgroundColor = "#ffffff";
...
$('#item_bag_item11').click(function () {
    ...
    if (document.getElementById('item_bag_input11').value == 'NULL') {
        ...
        document.getElementById('item_bag_cost').textContent = localStorage.bagCost+"원";
        document.getElementById('item_bag_subject').textContent = document.getElementById('item_bag_list11').value.toString();
    } else {
        item_row.style.backgroundColor = "#ffffff";
...
$('#item_bag_item12').click(function () {
    ...
    if (document.getElementById('item_bag_input12').value == 'NULL') {
        ...
        document.getElementById('item_bag_cost').textContent = localStorage.bagCost+"원";
        document.getElementById('item_bag_subject').textContent = document.getElementById('item_bag_list12').value.toString();
    } else {
        item_row.style.backgroundColor = "#ffffff";
